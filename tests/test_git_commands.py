    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ["|", "cat"],
                0,
            ),  # Pipe -- kann shell=False zwar nichts, aber kein Whitelist-Match
            (["&&", "ls"], 0),
            (["../../../etc/passwd"], 0),  # Pfad
...
class TestGitExecuteExtraArgs:
    ...
    @patch("elder_berry.comms.commands.git_commands.subprocess.run")
    def test_status_with_extra_args_rejected_not_silently_ignored(
